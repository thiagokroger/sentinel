...
class GovernanceClass(object):
    ...
    def list(self):
        ...
        # return a dict similar to zexcoind "gobject list" output
    ...
    def zexcoind_serialise(self):
        import zexcoinlib
        return zexcoinlib.SHIM_serialise_for_zexcoind(self.serialise())
